...
import com.ass.mcoerctest.Adapters.ViewPagerCarouselAdapter;
...
public class ViewPagerCarouselView extends RelativeLayout {
     ...
     */
    public void setData(FragmentManager fragmentManager, List<Notification> notificationList, long carouselSlideInterval) {
        this.fragmentManager = fragmentManager;
        this.notifications = notificationList;
        this.carouselSlideInterval = carouselSlideInterval;
        this.lastPageIndex = notificationList.size() - 1;
        initData();
        initCarousel();
        initCarouselSlide();
    }
    ...
    private void initData() {
        ...
        for (int i = 0; i < notifications.size(); i++) {
            ...
            if (i == 0 || i == notifications.size() - 1) obj.setVisibility(View.INVISIBLE);
    ...
    private void initCarousel() {
        if(carouselPageIndicators.size()>1) {
        ...
        ViewPagerCarouselAdapter viewPagerCarouselAdapter = new ViewPagerCarouselAdapter(fragmentManager, notifications);
    ...
    private void initCarouselSlide() {
        final int nCount = notifications.size();
        try {
